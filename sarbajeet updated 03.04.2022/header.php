		...
		<strong><em>Savoy Grill-Bar and Restaurant</em></strong>
            ...
            <div class="collapse navbar-collapse" id="navi">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="Check-in-and-gain-points.php" >Check in and gain points <span class="text-info">'.$gain.'</span></a>
                    ...
                    <li class="nav-item">
                    <a class="nav-link" href="pin-point.php" >Enter pin</a>
                </li>';   
                    }
                    }
                    //main page not logged in navigation bar
                    else { echo '<li class="nav-item">
                        <a class="nav-link" href="pin-point-user.php" >Enter pin</a>
                    </li>' ; } 
                    ?>
