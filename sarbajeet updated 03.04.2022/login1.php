...
<title>Savoy Grill and Bar</title>
<meta charset="utf-8">
...
<nav class="navbar navbar-expand-md navbar-light fixed-top">
        ...
        <strong><em>Savoy Grill-Bar and Restaurant</em></strong>
            </a>
            ...
            <!-- Modal body -->
                ...
                if(isset($_GET['error'])){
                    ...
                    if($_GET['error'] == "emptyfields") {   
                        ...
                        echo '<h5 class="bg-danger text-center">Error Occured,Email Exist ,Try again!</h5>';
                    }
                    else{
                        echo '<h5 class="bg-success text-center">All GOOD</h5>';
                ...
                if(isset($_GET['update'])) { 
                    ...
                    if($_GET['update'] == "success"){ 
                        echo '<h5 class="bg-success text-center">UPDATE  successfull! you can also check in your profile!</h5>';
                    }
                }
                echo'<br>';
                ?>
